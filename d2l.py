...
def load_data_fashion_mnist(batch_size, resize=None):
    ...
    mnist_train = torchvision.datasets.FashionMNIST(
        root="../03SoftMax/data", train=True, transform=trans, download=False)
    mnist_test = torchvision.datasets.FashionMNIST(
        root="../03SoftMax/data", train=False, transform=trans, download=False)
...
def train_ch3(net, train_iter, test_iter, loss, num_epochs, updater):
    ...
    assert train_acc <= 1 and train_acc > 0.01, train_acc
    assert test_acc <= 1 and test_acc > 0.01, test_acc
